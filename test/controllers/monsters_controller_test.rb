...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { health: @monster.health, name: @monster.name, x_pos: @monster.x_pos, y_pos: @monster.y_pos } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { health: @monster.health, name: @monster.name, x_pos: @monster.x_pos, y_pos: @monster.y_pos } }
